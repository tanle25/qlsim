...
<div id="dropdownMenu" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownButton">
      <li>
        <a href="{{url('dealer/export-doanh-thu-hom-nay')}}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Hôm nay</a>
      </li>
      <li>
        <a href="{{url('dealer/export-doanh-thu-tuan-nay')}}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Tuần này</a>
      </li>
      <li>
        <a href="{{url('dealer/export-doanh-thu-thang-nay')}}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Tháng này</a>
      </li>
      <li>
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                <form action="{{url('dealer/export-doanh-thu-tuy-chinh')}}" method="post">
                    @csrf
