            ...
            <div class="inline-block w-full shadow-md rounded-lg overflow-hidden pb-5">
                <table id="product-table" class="w-full leading-normal dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input form="share-sim" type="checkbox" name="sims[]" class="input-checkbox w-5 h-5" value="{{$simCard->id}}">
                            </td>
                            <td>
                                <div class="ml-3">
                            ...
                            <td>
                                <p data-sim="{{$simCard->id}}" class="show-popup whitespace-no-wrap {{ $simCard->partner  && $simCard->partner->expired->isPast() ? 'text-red-500' : ''}} ">
                            ...
                            <td>
                                <span
                                    ...
                                    <span class="relative">{{__(config('constrain.sim_status.'.$simCard->status.'.text'))}}</span>
                                </span>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-right">
                                ...
                                data-iccid="{{$simCard->iccid}}" data-history="{{url('admin/lich-su-thay-doi',$simCard->id)}}" >
...
<div id="dropdownLeft" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 dark:bg-gray-700 border shadow-lg" data-target="">
    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLeftButton">
        ...
        <li class="btn-history">
            <a href="#" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">{{__('Lịch sử thay đổi')}}</a>
        </li>
    </ul>
</div>
                ...
                <div class="p-6 text-center">
                    ...
                    <div id="myTabContent">
                        ...
                        <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                            <form action="{{url('admin/rent-sim-new-customer')}}" method="post" enctype="multipart/form-data">
                                @csrf
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div id="invoice-modal-body" class="p-6 text-center modal-body hidden">
                ...
                <div id="invoice-info" class="flex flex-col items-start">
                    <span class="text-sm text-gray-700 dark:text-white">Tên Khách hàng: <span id="customer-name" class="dark:text-white text-sm">ten</span> </span>
                    <span class="text-sm text-gray-700 dark:text-white">Link Facebook: <a id="customer-facebook"  class="dark:text-white text-sm text-green-500" href="" target="_blank" rel="noopener noreferrer"></a></span>
                    <span class="text-sm text-gray-700 dark:text-white">Ngày ký hợp đồng: <span id="contract-sign" class="dark:text-white text-sm">ten</span> </span>
                    <span class="text-sm text-gray-700 dark:text-white">Ngày thanh toán: <span id="pay-date" class="dark:text-white text-sm">ten</span> </span>
                    <span class="text-sm dark:text-white text-gray-700">Ngày kết thúc hợp đồng: <span id="bill-date" class="text-sm dark:text-white">Ngay ket thuc hop dong</span> </span>
                </div>
...
<div id="edit-expired" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
    <div class="relative w-full h-full max-w-md md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white close-datepicker" >
                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                <span class="sr-only">Close modal</span>
            </button>
            <div class="p-6 text-center">
...
var changeUrl = '';
    ...
    $('.show-popup').click(function(){
        ...
        $('#edit-expired input[name=sim]').val(sim);
        modal.show();
    });
